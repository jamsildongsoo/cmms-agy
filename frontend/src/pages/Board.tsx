                ...
                posts.map((post) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="p-3 font-mono text-slate-500">{post.createdAt.replace('T', ' ').substring(0, 16)}</td>
              ...
              <div className="border-b border-slate-850 pb-3 flex justify-between items-end">
                <div>
                  ...
                  <div className="flex gap-4 text-slate-500 font-mono text-[10px] mt-1.5">
                    ...
                    <span>작성일시: {selectedPost.createdAt.replace('T', ' ').substring(0, 16)}</span>
                  </div>
                </div>
                      ...
                      <div key={idx} className="bg-slate-950/20 border border-slate-850 p-3 rounded-lg flex justify-between items-start gap-4">
                        <div className="space-y-1">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-slate-650 font-mono text-[9px]">{comment.createdAt.replace('T', ' ').substring(0, 16)}</span>
                          </div>
        ...
        <div className="fixed inset-0 bg-slate-950/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-slate-900 border border-slate-800 rounded-2xl w-full max-w-xl shadow-2xl">
            ...
            <div className="p-6 border-t border-slate-800 flex justify-end gap-2">
              ...
              <button onClick={handleSavePost} disabled={isLoading} className="bg-blue-600 hover:bg-blue-500 text-white rounded-lg py-2 px-4 border-0 cursor-pointer disabled:opacity-50">저장 완료</button>
            </div>
          </div>
        </div>
      )}
