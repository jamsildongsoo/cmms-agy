...
@Entity
@Table(name = "pm_record_item")
@IdClass(PmRecordItemId.class)
@Getter
@Setter
public class PmRecordItem {
    ...
    @Id
    @Column(name = "pm_record_id", length = 50)
    ...
    @Column(name = "check_value", precision = 15, scale = 4)
